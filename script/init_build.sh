...
if [ $type = "foss" ]; then    
    ...
    #for 24.10, apply "24.10-nss" as MX4300 support is added in 24.10
    case $ver in
        "snapshot")   
            ...
            ;;
        "24.10"*)
            PATCH="https://github.com/openwrt/openwrt/compare/openwrt-24.10...qosmio:openwrt-ipq:24.10-nss.diff"
